...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("I:\\IdeaProjects\\gmall-parent\\service\\service-product\\src\\main\\java");
        globalConfig.setAuthor("zhongyuan");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.200.128:3306/online_edu?serverTimezone=GMT%2B8");
