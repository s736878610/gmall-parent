...
public class RedisConst {
    ...
    public static final String SECKILL_ORDERS = "seckill:orders";// 预订单的key
    public static final String SECKILL_ORDERS_USERS = "seckill:orders:users";// 用户下单成功后，存储订单信息的key
